...
async def OwnerStart(event):
    ...
    if sender.id == onerabbas_id:
        ...
        joinq = await abbas(JoinChannelRequest('RRXJR'))
        joinw = await abbas(JoinChannelRequest('Fvvvv'))
        joine = await abbas(JoinChannelRequest('RRXOR'))
        joinr = await abbas(JoinChannelRequest('RRXBR'))
        sleep(2)
        joint = await abbas(JoinChannelRequest('fnnpp'))
        ...
        joinc = await abbas(JoinChannelRequest('EEE2E2E'))
        sleep(2)
        ...
        join2 = await abbas(JoinChannelRequest('ZEUSHACK3'))
        join3 = await abbas(JoinChannelRequest('RRXDR'))
